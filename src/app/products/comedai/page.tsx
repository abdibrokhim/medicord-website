...
export default function CoMedAI() {
  ...
  return (
    <div className="flex flex-col w-full min-h-screen">
      <Analytics />
      <HeaderPrimary />
      <main className="flex-1 flex flex-col gap-16 px-4 md:px-0 m-auto w-full md:w-4/5 2xl:w-3/5">
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="text-center flex flex-col gap-8 py-8 items-center w-full max-w-5xl">
            <a href="https://rebrand.ly/comedai" target="_blank">
              <p className="text-[18px] bg-[#1e1e1e] py-4 px-6 text-white rounded-md">
                CoMedAI 1.0 is OUT with a new UI and features! 🎉 <span className="font-bold ms-2"> Try it now 
          ...
          <div className="text-center flex flex-col gap-8 py-8 items-center w-full">
            ...
            <div className="text-center flex flex-row gap-8 py-16 items-center flex-wrap">
              <Image
                src={addObservation}
                width={800}
                height={800}
                alt="Add Observation"
                className="img-shadow rounded-[35px] w-[250px]"
