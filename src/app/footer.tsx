...
// @ts-ignore
import logo from '../app/assets/Medicord_white_logo.png';


export default function Footer() {
  return (
<footer className="py-12 px-4 md:px-0 border-t-[1px] w-full !bg-[#1e1e1e]">
        <div className="flex flex-col md:flex-row justify-between gap-4 m-auto w-full md:w-4/5 2xl:w-3/5">
          ...
          <div className="flex items-center gap-x-16 gap-y-4 flex-wrap text-white text-xs"> <a className="link link-hover whitespace-nowrap" href="/terms">Terms</a> <a className="link link-hover whitespace-nowrap" href="/privacy">Privacy Policy</a> <a className="link link-hover whitespace-nowrap" href="/about">About</a>
            <p className="whitespace-nowrap">© 2024 Medicord, Inc.</p>
            <div className="flex items-center gap-3"> 
              <a className="clickable" href="https://www.linkedin.com/company/gpthub/" target="_blank" rel="noopener noreferrer">
