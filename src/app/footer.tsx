...
// @ts-ignore
import logo from '../app/assets/comed_logo_white.png';
...
<footer className="py-12 px-4 md:px-0 border-t-[1px] w-full !bg-[#1e1e1e]">
        <div className="flex flex-col md:flex-row justify-between gap-4 m-auto w-full md:w-4/5 2xl:w-3/5">
          ...
          <div className="flex items-center gap-x-16 gap-y-4 flex-wrap text-white text-xs"> <a className="link link-hover whitespace-nowrap" href="https://linkedin.com/company/comedai">Terms</a> <a className="link link-hover whitespace-nowrap" href="https://linkedin.com/company/comedai">Privacy Policy</a> <a className="link link-hover whitespace-nowrap" href="https://linkedin.com/company/comedai">About</a>
            <p className="whitespace-nowrap">© 2024 CoMed, Inc.</p>
            <div className="flex items-center gap-3"> 
              <a className="clickable" href="https://www.linkedin.com/company/comedai/" target="_blank" rel="noopener noreferrer">
