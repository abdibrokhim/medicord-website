            ...
            <div className="flex flex-col justify-center md:w-1/2 w-full">
              ...
              <div className="flex flex-row justify-center items-center gap-2 mt-16">
                <input
                  ...
                  className="border border-gray-300 rounded-md p-2 w-full max-w-sm outline-noneborder border-[#1e1e1e] rounded-md p-2 w-full max-w-sm shadow-[0_4px_6px_-1px_rgba(30,30,30,0.1),0_2px_4px_-1px_rgba(30,30,30,0.06)] focus:outline-none focus:ring-2 focus:ring-[#1e1e1e]"
                  />
                <a className="cta-top flex gap-2 items-center justify-center rounded-md hover:opacity-80 active:opacity-60 active:scale-95 transition-all text-white text-[16px] px-6 h-[40px] shrink-0 grow-0 btn hover:opacity-80 !bg-[#1e1e1e] !text-white !bg-none !text-[18px] px-6 !h-[44px]" href="https://abdibrokhim.vercel.app">
